...
TokenSequence learn_wrapper(BPE& self, const nb::object& tokens, const nb::object& input_vocab = nb::none(), bool debug = false) {
...
void learn_defrag_wrapper(DefragEncoder& self, const nb::object& tokens, const nb::object& input_vocab = nb::none(), bool debug = false) {
    TokenSequence tokens_seq = convert_to_token_sequence(tokens);
    std::optional<VocabSet> vocab_opt = convert_to_vocab_set_optional(input_vocab);
...
void learn_contextual_wrapper(ContextualEncoder& self, const nb::object& tokens, const nb::object& input_vocab = nb::none(), bool debug = false) {
    TokenSequence tokens_seq = convert_to_token_sequence(tokens);
    std::optional<VocabSet> vocab_opt = convert_to_vocab_set_optional(input_vocab);
...
void learn_composed_wrapper(ComposedTokenizer& self, const nb::object& tokens, const nb::object& input_vocab = nb::none(), bool debug = false) {
    TokenSequence tokens_seq = convert_to_token_sequence(tokens);
    std::optional<VocabSet> vocab_opt = convert_to_vocab_set_optional(input_vocab);
...
NB_MODULE(contok, m) {
    ...
    nb::class_<bpe::BPE>(bpe_submodule, "BPE")
        ...
        .def("learn", &bpe_bindings::learn_wrapper, "tokens"_a, "input_vocab"_a = nb::none(), "debug"_a = false)
    ...
    nb::class_<bpe::DefragEncoder>(bpe_submodule, "DefragEncoder")
        .def(nb::init<>())
        .def("learn", &bpe_bindings::learn_defrag_wrapper, "tokens"_a, "input_vocab"_a = nb::none(), "debug"_a = false)
    ...
    nb::class_<bpe::ComposedTokenizer>(bpe_submodule, "ComposedTokenizer")
        ...
        .def("learn", &bpe_bindings::learn_composed_wrapper, "tokens"_a, "input_vocab"_a = nb::none(), "debug"_a = false)
