...
if importlib.util.find_spec("lz_cpp") is None:
    pytest.skip("lz_cpp module not found. Skipping comparison tests.", allow_module_level=True)

# Import C++ implementation
from lz_cpp import LZCoder as CppLZCoder, HierarchicalLZCoder as CppHierarchicalLZCoder, ensure_list as cpp_ensure_list, EMPTY_TOKEN as CPP_EMPTY_TOKEN
